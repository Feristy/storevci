...
<table class="table table-striped table-bordered" id="myTable">
	...
	<?php  foreach($slide as $slide_item):?>
		<tr>
			...
			<td><?=$slide_item->title?></td>
			<td class="tb-act">
				<div class="btn-group btn-group-xs">
					<a href="edit-slide/<?=$slide_item->id?>" class="btn btn-primary btn-table" title="Edit">
						<i class="fa fa-pencil-alt fa-fw"></i></a>
					<button type="submit" class="btn btn-danger btn-table" title="Hapus" name="del" value="<?=$slide_item->id?>">
